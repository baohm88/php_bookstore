...
<button class="success" onclick="backToAdminOrdersList()"><i class="bi bi-chevron-left"></i> Back to Orders List</button>

<h1 class="center">Order# <?= $order_id ?> on <?= $order_date ?> </h1>
    ...
    <table>
        ...
        <tbody>
            <?php foreach ($order_items as $item): ?>
                <tr>
                    <td>
                        <a href="http://programmingbooks-store.free.nf/books/book/?id=<?= $item->book_id ?>">
